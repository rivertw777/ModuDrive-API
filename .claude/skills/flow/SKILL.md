...
description: >-
  Run the full git workflow end-to-end for this repo (ModuDrive-API) — infer everything from
  the current working tree and ship it: create a GitHub issue, branch, verify the Gradle build,
