...
- 선택 이유(Kafka·RabbitMQ 비교), 큐 설정, task role 권한은 `.docs/spec/messaging-spec.md` 1장.
...
- 현재 알림: Grafana 알림 규칙(`.docker/observability/grafana/alerting/alerts.yaml`) → 디스코드 채널 2개. 규칙 목록은 `.docs/spec/discord-alert-spec.md`.
