...
@WebMvcTest(ListAllFilesController.class)
@Import(GlobalExceptionHandler.class)
class ListAllFilesControllerTest {

    @Autowired private MockMvc mockMvc;
    @MockitoBean private ListAllFilesUseCase listAllFilesUseCase;

    private static final String USER_ID = "11111111-1111-1111-1111-111111111111";

    @Nested
    @DisplayName("GET /api/v1/files/all")
    class ListAllFiles {

        @Test
        void returnsAllFileList() throws Exception {
            ...
            given(listAllFilesUseCase.listAllFiles(any(ListAllFilesCommand.class))).willReturn(List.of(file));

            mockMvc.perform(get("/api/v1/files/all").header("X_USER_ID", USER_ID))
