...
class GetFilesByCategoryServiceTest {
    ...
    class WhenNamespaceExists {
        ...
        @Test
        void returnsOnlyFilesMatchingCategory() {
            ...
            List<File> result = getFilesByCategoryService.getFilesByCategory(command);

            assertThat(result).hasSize(1);
            assertThat(result.get(0).getName()).isEqualTo("photo.png");
        }
    }
    ...
    class WhenNamespaceNotFound {
        ...
        void throwsNamespaceNotFound() {
            ...
            Throwable thrown = catchThrowable(() -> getFilesByCategoryService.getFilesByCategory(command));
