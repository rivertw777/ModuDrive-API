...
@WebMvcTest(ListTrashController.class)
@Import(GlobalExceptionHandler.class)
class ListTrashControllerTest {

    @Autowired private MockMvc mockMvc;
    @MockitoBean private ListTrashUseCase listTrashUseCase;

    private static final String USER_ID = "11111111-1111-1111-1111-111111111111";

    @Nested
    @DisplayName("GET /api/v1/files/trash")
    class ListTrash {
